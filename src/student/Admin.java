...
public class Admin implements ActionListener{
        ...
        public Admin() throws IOException
        {
            ...
            frm =new JFrame("Student Payment System-Admininstrator Zone");
            frm.setLayout(null);
            frm.setSize(600,400);
            frm.setVisible(true);
           ...
           // img = new Image(getClass().getResource("desktop/bavkground.png"));
            p1 = new MyPanel();
            ...
            l3 = new JLabel("Student Payment System-Admin");
     ...
     public void actionPerformed(ActionEvent e) 
        {
                ...
                if(t1.getText()!=null )
            {
                ...
                {       String user = t1.getText();
                        ...
                        PreparedStatement stmt = con.prepareStatement("Select * from admin Where username='" + user + "'");
                        ...
                        if(username.equalsIgnoreCase(t1.getText()) && password.equalsIgnoreCase(t2.getText()))
                        {
                            try
                            {
                                AdminInfo h = new AdminInfo();
                                h.lunch(name,username);
